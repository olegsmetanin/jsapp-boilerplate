({constructor:function(Ja,Ka){var F,La="Leaflet is not loaded!";F=function(a){function b(){if("undefined"===typeof L)if(c++,9>c)window.setTimeout(b,200*Math.pow(2,c));else throw La;else a()}var c=0;b()};var l=function(a){function b(a){for(k=1;a=c.shift();)a()}var c=[],d,e=document,f=e.documentElement,g=f.doScroll,k=/^loade|c/.test(e.readyState);e.addEventListener&&e.addEventListener("DOMContentLoaded",d=function(){e.removeEventListener("DOMContentLoaded",d,!1);b()},!1);g&&e.attachEvent("onreadystatechange",
...
var B;if(("jsonp"==r.type||"GET"==q)&&j)v=v+(/\?/.test(v)?"&":"?")+j,j=null;if("jsonp"==r.type){n=v;j=w++;var q=r.jsonpCallback||"callback",v=r.jsonpCallbackName||d.getcallbackPrefix(j),E=RegExp("((^|\\?|&)"+q+")=([^&]+)"),D=n.match(E),z=u.createElement("script"),F=0,I=-1!==navigator.userAgent.indexOf("MSIE 10.0");D?"?"===D[3]?n=n.replace(E,"$1="+v):v=D[3]:n=n+(/\?/.test(n)?"&":"?")+(q+"="+v);p[v]=a;z.type="text/javascript";z.src=n;z.async=!0;"undefined"!==typeof z.onreadystatechange&&!I&&(z.event=
"onclick",z.htmlFor=z.id="_reqwest_"+j);z.onload=z.onreadystatechange=function(){if(z[H]&&"complete"!==z[H]&&"loaded"!==z[H]||F)return!1;z.onload=z.onreadystatechange=null;z.onclick&&z.onclick();r.success&&r.success(x);x=void 0;t.removeChild(z);F=1};t.appendChild(z);n=void 0}else{B=C();B.open(q,v,!0);q=r.headers||{};q.Accept=q.Accept||y.accept[r.type]||y.accept["*"];!r.crossOrigin&&!q[m]&&(q[m]=y.requestedWith);q[l]||(q[l]=r.contentType||y.contentType);for(n in q)q.hasOwnProperty(n)&&B.setRequestHeader(n,
...
typeof module&&module.exports?module.exports=l():"function"==typeof define&&define.amd?define(l):this.reqwest=l();var m=window,t=document,w=location,x=window.setTimeout,va=decodeURIComponent,wa=encodeURIComponent,P=function(a,b){var c=typeof a[b];return"function"==c||!!("object"==c&&a[b])||"unknown"==c},xa=function(){if(!C(navigator.plugins)&&"object"==typeof navigator.plugins["Shockwave Flash"]){var a=navigator.plugins["Shockwave Flash"].description;a&&(!C(navigator.mimeTypes)&&navigator.mimeTypes["application/x-shockwave-flash"]&&
...
b)},outgoing:function(a,b){this.down.outgoing(a,b)},callback:function(a){this.up.callback(a)},init:function(){this.down.init()},destroy:function(){this.down.destroy()}},d=0,e=a.length;d<e;d++)b=a[d],q(b,c,!0),0!==d&&(b.down=a[d-1]),d!==e-1&&(b.up=a[d+1]);return b},da=this,Aa=Math.floor(1E4*Math.random()),ia=Function.prototype,ba=/^((http.?:)\/\/([^:\/\s]+)(:\d+)*)/,ya=/[\-\w]+\/\.\.\//,Pa=/([^:])\/\//g,W="",h={},Qa=m.easyXDM,E="easyXDM_",ca,za=!1,M,ha,D,R;if(P(m,"addEventListener"))D=function(a,b,
c){a.addEventListener(b,c,!1)},R=function(a,b,c){a.removeEventListener(b,c,!1)};else if(P(m,"attachEvent"))D=function(a,b,c){a.attachEvent("on"+b,c)},R=function(a,b,c){a.detachEvent("on"+b,c)};else throw Error("Browser not supported");var N=!1,$=[];"readyState"in t?(l=t.readyState,N="complete"==l||~navigator.userAgent.indexOf("AppleWebKit/")&&("loaded"==l||"interactive"==l)):N=!!t.body;if(!N){if(P(m,"addEventListener"))D(t,"DOMContentLoaded",aa);else if(D(t,"readystatechange",function(){"complete"==
...
Object.toJSON(b).replace(/\s/g,"")&&(a.stringify=Object.toJSON);"function"===typeof String.prototype.evalJSON&&(b='{"a":[1,2,3]}'.evalJSON(),b.a&&(3===b.a.length&&3===b.a[2])&&(a.parse=function(a){return a.evalJSON()}));return a.stringify&&a.parse?(ka=function(){return a},a):null};q(h,{version:"2.4.17.1",query:v,stack:{},apply:q,getJSONObject:ka,whenReady:O,noConflict:function(a){m.easyXDM=Qa;(W=a)&&(E="easyXDM_"+W.replace(".","_")+"_");return h}});h.DomHelper={on:D,un:R,requiresJSON:function(a){"object"==
...
A(a.remote),a.isHost);a.isHost&&(ha&&a.swfNoThrottle&&q(a.props,{position:"fixed",right:0,top:0,height:"20px",width:"20px"}),q(a.props,{src:Q(a.remote,{xdm_e:A(w.href),xdm_c:a.channel,xdm_p:6,xdm_s:a.secret}),name:E+a.channel+"_provider"}),d=I(a))};if(h.stack.FlashTransport[k]&&h.stack.FlashTransport[k].init)j();else if(h.stack.FlashTransport[k])h.stack.FlashTransport[k].queue.push(j);else{h.stack.FlashTransport[k]={queue:[j]};var j=a.swf+"?host="+a.isHost,p="easyXDM_swf_"+Math.floor(1E4*Math.random());
...
J)}function e(){u&&x(function(){u(!0)},0)}var f,g,k,j,p,u,J,n;return f={outgoing:function(a,c,d){u=d;b(a)},destroy:function(){k.parentNode.removeChild(k);k=null;g&&(j.parentNode.removeChild(j),j=null)},onDOMReady:function(){g=a.isHost;p=0;J=A(a.remote);a.local=V(a.local);g?(h.Fn.set(a.channel,function(b){g&&"ready"===b&&(h.Fn.set(a.channel,d),c())}),n=Q(a.remote,{xdm_e:a.local,xdm_c:a.channel,xdm_p:2}),q(a.props,{src:n+"#"+a.channel,name:E+a.channel+"_provider"}),j=I(a)):(a.remoteHelper=a.remote,
h.Fn.set(a.channel,d));var b=function(){var d=k||this;R(d,"load",b);h.Fn.set(a.channel+"_load",e);(function Na(){"function"==typeof d.contentWindow.sendMessage?c():x(Na,50)})()};k=I({props:{src:a.local+"#_4"+a.channel},onLoad:b})},init:function(){O(f.onDOMReady,f)}}};h.stack.HashTransport=function(a){function b(){if(j){var a=j.location.href,b="",d=a.indexOf("#");-1!=d&&(b=a.substring(d));b&&b!=g&&(g=b,c.up.incoming(g.substring(g.indexOf("_")+1),h))}}var c,d,e,f,g,k,j,p,u,h;return c={outgoing:function(b){p&&
...
a.channel+"_consumer"]}catch(d){}j?(e=setInterval(b,f),c.up.callback(!0)):x(Ma,50)})()}p=I(a)}else j=m,e=setInterval(b,f),u?(p=parent,c.up.callback(!0)):(q(a,{props:{src:a.remote+"#"+a.channel+new Date,name:E+a.channel+"_consumer"},onLoad:function(){c.up.callback(!0)}}),p=I(a))},init:function(){O(c.onDOMReady,c)}}};h.stack.ReliableBehavior=function(){var a,b,c=0,d=0,e="";return a={incoming:function(f,g){var k=f.indexOf("_"),j=f.substring(0,k).split(",");f=f.substring(k+1);j[0]==c&&(e="",b&&(b(!0),
...
this._yandex.setZoom(c);this._yandex.panTo(b,{duration:0,delay:0})}},_resize:function(a){var b=this._map.getSize(),c=this._container.style;c.width==b.x+"px"&&c.height==b.y+"px"&&!0!=a||(this.setElementSize(this._container,b),a=this._map.getBounds(),a.getSouthWest(),a.getNorthEast(),this._yandex.container.fitToViewport())}})});var y=this;F=y.Class;var T=y.DomUtil,qa=y.bean,Ia=y.PubSub,Sa=y.reqwest,S=y.JSON;delete y.Class;delete y.DomUtil;delete y.bean;delete y.PubSub;delete y.reqwest;delete y.easyXDM;
delete y.JSON;delete y.jsface;F=F({constructor:function(){},map:function(a){this.current=L.map(T.get(a)).setView([0,0],5);L.tileLayer("http://{s}.tile.cloudmade.com/BC9A493B41014CAABB98F0471D759707/997/256/{z}/{x}/{y}.png",{maxZoom:18,attribution:'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery \ufffd <a href="http://cloudmade.com">CloudMade</a>'}).addTo(this.current)},dom:function(a,
...
error:function(a){console.log(S.stringify(a))}})})}});y.Samples=F;Ka[Ja]=this}}).constructor("App",this);
